...
function getPlacementData({ anchorRect: p4, popperSize: c5, arrowSize: f4, arrowOffset: l6 = 0, side: d4, sideOffset: h4 = 0, align: x3, alignOffset: g4 = 0, shouldAvoidCollisions: u4 = true, collisionBoundariesRect: w3, collisionTolerance: m4 = 0 }) {
  if (!p4 || !c5 || !w3) return { popperStyles: o9, arrowStyles: n3 };
  ...
  const R2 = s(S3, $3), M2 = y4[a(d4)][x3], D = function(t12, e12, r13) {
    ...
    if (("start" === o14 || "center" === o14) && (n6[p5] && c6 || n6[a4] && !c6)) return "end";
    if (("end" === o14 || "center" === o14) && (n6[a4] && c6 || n6[p5] && !c6)) return "start";
    return o14;
  ...
  const { present: o14, children: i5 } = u4, s5 = function(n6) {
    ...
    return t7.useEffect(() => {
      ...
      if (t12 !== n6) {
        ...
        if (n6) m4("MOUNT");
        else if ("none" === o16 || "none" === (null == e12 ? void 0 : e12.display)) m4("UNMOUNT");
        else {
          const e13 = u6 !== o16;
...
function composeEventHandlers(e12, n6, { checkForDefaultPrevented: t12 = true } = {}) {
  return function(r13) {
    if (null == e12 || e12(r13), false === t12 || !r13.defaultPrevented) return null == n6 ? void 0 : n6(r13);
  };
}
...
function names_default(e12, f4) {
  ...
  e12.prototype.toName = function(f5) {
    ...
    if (null == f5 ? void 0 : f5.closest) {
      ...
      if (!l6.length) for (var c5 in a4) l6[c5] = new e12(a4[c5]).toRgb();
      for (var g4 in a4) {
...
function c4(e12, r13) {
  ...
  for (n6 = 0; n6 < a4.length; n6++) r13.indexOf(t12 = a4[n6]) >= 0 || (o14[t12] = e12[t12]);
  return o14;
}
function i4(e12) {
...
var d3 = function(e12, r13, t12) {
  var n6 = e12.getBoundingClientRect(), o14 = f3(r13) ? function(e13, r14) {
    for (var t13 = 0; t13 < e13.length; t13++) if (e13[t13].identifier === r14) return e13[t13];
    return e13[0];
  }(r13.touches, t12) : r13;
...
var F = function(e12, r13) {
  if (e12 === r13) return true;
  for (var t12 in e12) if (e12[t12] !== r13[t12]) return false;
  return true;
};
...
function __generator(thisArg, body) {
  var _3 = { label: 0, sent: function() {
    ...
    return t12[1];
  }, trys: [], ops: [] }, f4, y4, t12, g4 = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
  ...
  function step(op) {
    ...
    while (g4 && (g4 = 0, op[0] && (_3 = 0)), _3) try {
      if (f4 = 1, y4 && (t12 = op[0] & 2 ? y4["return"] : op[0] ? y4["throw"] || ((t12 = y4["return"]) && t12.call(y4), 0) : y4.next) && !(t12 = t12.call(y4, op[1])).done) return t12;
      if (y4 = 0, t12) op = [op[0] & 2, t12.value];
      switch (op[0]) {
        case 0:
        case 1:
          t12 = op;
...
function __read(o14, n6) {
  ...
  try {
    while ((n6 === void 0 || n6-- > 0) && !(r13 = i5.next()).done) ar.push(r13.value);
  } catch (error) {
    e12 = { error };
  } finally {
    try {
...
function _unsupportedIterableToArray(o14, minLen) {
  ...
  if (n6 === "Object" && o14.constructor) n6 = o14.constructor.name;
  if (n6 === "Map" || n6 === "Set") return Array.from(o14);
  if (n6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6)) return _arrayLikeToArray(o14, minLen);
}
...
function _unsupportedIterableToArray2(o14, minLen) {
  ...
  if (n6 === "Object" && o14.constructor) n6 = o14.constructor.name;
  if (n6 === "Map" || n6 === "Set") return Array.from(o14);
  if (n6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6)) return _arrayLikeToArray2(o14, minLen);
}
